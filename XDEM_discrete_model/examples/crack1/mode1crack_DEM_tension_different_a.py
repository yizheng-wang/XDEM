...
for index, a in enumerate(np.arange(0.2, 0.91, 0.1)):
    ...
    x_crackTip = a
    model_name = output_dir = f'../../result/crack1/crack_DEM/different_a/a_{a:.1f}/crack'
...
plt.plot(a_values, k1_j_values, 'b-', linewidth=2, label='DEM (J-integral)', marker='s', markersize=5)
...
# Add value annotations for DEM K1 values
...
comparison_plot_path = '../../result/crack1/crack_DEM/different_a/k1_comparison_different_a.pdf'
...
results_csv_path = '../../result/crack1/crack_DEM/different_a/k1_results_different_a.csv'
